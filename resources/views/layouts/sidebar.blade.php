...
<a href="index3.html" class="brand-link">
    <img src="dist/img/AdminLTELogo.png" alt="Super Apps Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                        ...
                        @foreach ($menu->children as $child)
                            <li class="nav-item">
                                <a href="{{ url($child->url) }}" class="nav-link">
                                    ...
                                    <p>{{ $child->title }}{!! $menu->created_at && $menu->created_at->gt(now()->subDays(2))
                                        ? '<span class="right badge badge-success">New</span>'
                                        : '' !!}
                                    </p>
                                </a>
